...
// //     return App.init();
// // }) or
// window.addEventListener('load', App.init()); // initialize App
...
function init() {
    ...
    view.bindPlayerMoveEvent((square) => {
        ...
        store.playerMove(+square.id); // +clickedSqure.id : + to cast to number
...
window.addEventListener('load', init); // initialize App
